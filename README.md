...
# PULSAR-QUEUE
**Server connection queue and slot management for Pulsar Framework**
...
Manages the player connection queue, enforcing slot limits and priority access. Configurable queue behaviour via `config.lua`.
